exports.seed = async function(knex) {
  ...
  await knex('exercises').insert([
    ...
    },
    {
      ...
      category_id: getCategory('可動域改善')?.id,
      name: '膝伸展運動（座位）',
      description: '座位での膝伸展により可動域を改善し、大腿四頭筋の筋力も同時に向上させる',
      instructions: '【準備】\n• 安定した椅子を用意（車輪付きは避ける）\n• 椅子の高さは膝が90度になる程度に調整\n• 足裏が完全に床につく状態を確保\n• タオルを膝の下に置いても可（滑りやすくするため）\n\n【開始姿勢】\n• 椅子に深く腰掛け、背もたれに背中をしっかりつけます\n• 両手は椅子の座面や肘掛けに置いて体を安定させます\n• 足裏は床にしっかりとつけ、膝を約90度に曲げます\n• 上体はまっすぐに保ち、リラックスした状態を作ります\n\n【実施方法】\n1. 深呼吸をして体をリラックスさせます\n2. 患側の膝をゆっくりと伸ばし始めます（2-3秒かけて）\n3. 大腿四頭筋（太ももの前）に力を入れながら可能な限り伸ばします\n4. 膝が完全に伸びきった状態で3秒間キープします\n5. 大腿四頭筋の収縮を意識しながら保持します\n6. ゆっくりと制御しながら元の90度の位置に戻します（2-3秒かけて）\n7. 足裏が床につく直前で次の動作を開始します\n\n【コツとポイント】\n• 膝を伸ばす時は足首も一緒に背屈（つま先を上に向ける）\n• 太ももの前の筋肉が硬くなっているのを手で確認\n• 勢いをつけずにゆっくりとした動作で行う\n• 呼吸を止めずに自然に続ける\n• 健側の足でも同様に行い、左右の違いを確認\n\n【段階的進歩】\n• Week 1: 膝伸展角度120度程度から開始\n• Week 2: 膝伸展角度150度程度を目標\n• Week 3-4: 完全伸展（180度）を達成\n• Week 5以降: 左右差の解消と筋力向上を重視\n\n【進歩の目安】\n• 完全に伸びるようになることが最終目標\n• 健側と患側の伸展角度差が5度以内\n• 保持時間を徐々に延長（最大10秒まで）\n• 痛みなく滑らかな動作ができる\n\n【注意点】\n• 膝の後ろが突っ張る程度の痛みは正常な反応\n• 鋭い痛みや電気が走るような痛みは即座に中止\n• 無理に伸ばそうとして反動をつけない\n• 腫れや熱感が増した場合は一時中断\n• めまいや体調不良を感じたら休憩する',
      difficulty_level: 'beginner',
      default_sets: 3,
      default_reps: 12,
      default_duration_seconds: 3,
